...
namespace GeneralClass
{
    public  class Program
    {
        ...
        public  int DatabaseConnect()
        {
            try
            {
                string strDBConnectionString = "DSN=mdcDataEntry;uid=sa;pwd=dbadmin";
    ...
    public class Student : User
    {
        ...
        public string strHighSchoolMarks = "";
        public string strGodarat = "";
        public string strKnowExam = "";
        public string strStudyOptions = "";
        public string strAlternateCollege = "";
        #endregion
        ...
        public int SaveStudent()
        {
            ...
            {                
                ...
                objProgram.Add("college_id", this.strCollegeId, "I");
                ...
                //}
                    objProgram.Add("secondary_option", this.strAlternateCollege, "S");
                ...
                objProgram.Add("school_name", this.strSchoolName, "S");
                if (this.strSchoolCity != "")
                {
                    objProgram.Add("city", this.strSchoolCity, "I");
                }
                objProgram.Add("country", this.strShcoolCountry, "I");
                objProgram.Add("graduation_year", this.strGraduationyear, "S");
                objProgram.Add("highschool_grade", this.strHighSchoolMarks, "I");
                objProgram.Add("gudrat_grade", this.strGodarat, "I");
                objProgram.Add("tahseeli_grade", this.strKnowExam, "I");
                objProgram.Add("program_options", this.strStudyOptions, "S");
        ...
        public Student GetStudentByID(string strStudentID)
        {
            ...
            try
            {
                ...
                if (objProgram.drData.Read())
                {
                    ...
                    objResult.strCollegeId = objProgram.drData["college_id"].ToString();
                    objResult.strCollegeName = objProgram.drData["college_name"].ToString();
                    ...
                    objResult.strAlternateCollege = objProgram.drData["secondary_option"].ToString();                                         
                }
                ...
                objProgram.strSql = "SELECT D.local_id,A.id As 'Record_id',A.*,B.*,C.*,E.secondyearpercentage AS sec_year,E.thirdyearpercent as third_year,F.gudrat_grade AS gudrat_marks,G.tahsili_mark As tahseeli_marks FROM  student_academic_data A INNER JOIN country_preset B ON A.country = B.id LEFT OUTER JOIN city_preset C " +
                                    " ON A.city = C.id INNER JOIN student_registration D ON A.student_id = D.id LEFT OUTER JOIN high_school_master E ON  cast(D.local_id as nvarchar) = E.local_id " +
                                    " LEFT OUTER JOIN imported_data_new F ON cast(D.local_id as nvarchar) = F.local_id LEFT OUTER JOIN Tehseeli_results G ON  cast(D.local_id as nvarchar) = G.local_id WHERE D.id =  " + strStudentID + " ORDER BY F.gudrat_grade DESC"; 
                ...
                if (objProgram.drData.Read())
                {
                    ...
                    objResult.strSchoolName = objProgram.drData["school_name"].ToString();
                    objResult.strSchoolCity = objProgram.drData["city_name"].ToString();
                    objResult.strShcoolCountry = objProgram.drData["country_name"].ToString();
                    objResult.strGraduationyear = objProgram.drData["graduation_year"].ToString();
                    //objResult.strHighSchoolMarks = strSchoolGrade; 
                    //objResult.strGodarat = objProgram.drData["gudrat_marks"].ToString();
                    //objResult.strKnowExam = objProgram.drData["tahseeli_marks"].ToString();

                    objResult.strHighSchoolMarks = objProgram.drData["highschool_grade"].ToString(); ;
                    objResult.strGodarat = objProgram.drData["gudrat_grade"].ToString();
                    objResult.strKnowExam = objProgram.drData["tahseeli_grade"].ToString();
                    objResult.strStudyOptions = objProgram.drData["program_options"].ToString();
